...
class concierged_preneed_funeral : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_concierged_preneed_funeral, container, false)

        db = FirebaseFirestore.getInstance()
        userId = FirebaseAuth.getInstance().currentUser?.uid ?: ""

        // Example product data
        val product = PackageItem("conciergedfuneralpackage","Concierged Pre-need Funeral Package",
            R.drawable.preneed_funeral.toString(),42280.00,imageType = "resourceId")
